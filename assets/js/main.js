...
var BootstrapActions = {
		...
		if ( document.getElementById('newsletter-popup-form') ) {
			setTimeout(function() {
				...
				if (mpInstance.isOpen) {
					mpInstance.close();
					setTimeout(function() {
						BootstrapActions.newsletterPopup();
					},360);
				}
				else {
					BootstrapActions.newsletterPopup();
	...
	ajaxLoading: function () {
		$('body').append("<div class='ajax-overlay'><i class='BootstrapActions-loading-icon'></i></div>");
	},
	wordRotate: function () {
	...
	parallax: function() {
		...
		wrappers.each(function() {
			...
			// If enabled
			if ( ! BootstrapActions.mobile || options.enableOnMobile ) {
...
(function ($) {
	...
	$(window).on('load', function () {
		...
		BootstrapActions.scrollBtnAppear();
	});
